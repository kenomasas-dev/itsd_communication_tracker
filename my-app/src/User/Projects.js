...
export default function Projects() {
  ...
  useEffect(() => {
    if (showAttachmentModal && viewingAttachment) {
      recordAuditLog(
        'VIEW_DOCUMENT',
        `Viewed document/attachment: ${viewingAttachment.name} (Communication #${viewingAttachment.trackingId || (selected ? (selected.tracking_id || selected.id) : 'Unknown')})`
      );
    }
  }, [showAttachmentModal, viewingAttachment, selected]);
